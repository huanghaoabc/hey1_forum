...
Page({
  ...
  data: {
    ...
    xingbie:gse.listSelectTab[3].type,
    imagesArrIndex:0
  ...
  getDes: function(){
    articles.getDes({
      ...
      if (res.isDelete == 1){
        ...
        var detail =res;
        if(detail.playNum <= 9999)
          {
            detail.playNum=(detail.playNum/1000).toFixed(1)+"K"
          }else
          {
            detail.playNum=(detail.playNum/10000).toFixed(1)+"W"
          }
          if(detail.fandsNum <= 9999)
          {
            detail.fandsNum=(detail.fandsNum/1000).toFixed(1)+"K"
          }else
          {
            detail.fandsNum=(detail.fandsNum/10000).toFixed(1)+"W"
          }
        this.setData({
          actions,
          ks:JSON.parse(res.kuaishouinfo),
          detailInfo:detail
        })
      ...
      this.setData({
        ...
        this.articlesList(res.circle_id);
    })
  },
  ...
  previewImg:function(e){
    ...
    var imgArr = this.data.data.images;
    wx.previewImage({
  ...
  ,tabImageFn:function (e)
  {
    var index = e.currentTarget.dataset.index;
    this.setData({
      imagesArrIndex:index
    })
  },articlesList: function (cid) {
