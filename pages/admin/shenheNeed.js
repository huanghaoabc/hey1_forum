...
Page({
  ...
  },returnIndex (arr,i)
  {
    ...
    articles.getDes({
      ...
      g.playCount_type = ks.playCount_type;
      ...
      this.setData({
        ...
        ks:ks,
          ...
          fandsNeedArrIndex:this.returnIndex(this.data.fandsNeedArr,ks.fands_need),          
          playTypeArrIndex:this.returnIndex(this.data.playTypeArr,ks.playCount_type),
          ...
          GenderIndex:this.returnIndex(this.data.Gender,ks.is_Gender),
          data:d
